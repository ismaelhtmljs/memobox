...
export default function HeaderNews({AsideNewsOpen} : {AsideNewsOpen : () => void}) {
  return (
    <>
      <header className="bg-moded p-moded text-mod sticky top-0">
        <div className="p-1.5 flex justify-around items-center memonew-h-res">
          <div className="flex gap-2.5 items-center">
            ...
            <IoMenuSharp onClick={AsideNewsOpen} className="text-xl hidden menu-res"/>
          </div>
          <nav>
